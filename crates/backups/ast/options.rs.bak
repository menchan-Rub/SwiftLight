...
impl Default for CompileOptions {
    fn default() -> Self {
        Self {
            ...
            output_file: None,
            input_files: Vec::new(),
            dependent_type_check_level: 2,
            metaprogramming_limit: 1,
            compile_time_computation_limit: 30,
            memory_safety_level: 0,
            ...
            inline_strategy: InlineStrategy::Hint,
            thread_model: ThreadModel::Lightweight,
